...
class ControlStateDeprecated(EnumMeta):
    def __getattribute__(self, item):
        if item in [
            ...
            warn(
                "ControlState enum is deprecated and will be removed in version 0.26.0. "
...
class ControlState(Enum, metaclass=ControlStateDeprecated):
    HOVERED = "hovered"
    FOCUSED = "focused"
    PRESSED = "pressed"
    DRAGGED = "dragged"
